...
export function ThemeToggle() {
    ...
    return (_jsx(_Fragment, { children: _jsxs(ThemeProvider, { theme: { mode: theme }, children: [_jsx(GlobalStyle, {}), _jsx(ToggleContainer, { onClick: toggleTheme, children: _jsx(ToggleBall, { children: theme === "light" ? _jsx(Icon, { as: Sun }) : _jsx(Icon, { as: Moon }) }) })] }) }));
}
